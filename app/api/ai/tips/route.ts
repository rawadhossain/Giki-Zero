...
async function generateSampleTips(submissionData: any, totalScore: number, impactCategory: string) {
  ...
  // Transportation tips
  if (submissionData.transportationType === "car-gasoline" || submissionData.transportationType === "car-diesel") {
    tips.push({
  ...
  // Energy tips
  if (submissionData.electricityUnits === "high" || submissionData.electricityUnits === "very-high") {
    tips.push({
  ...
  // Travel tips
  if (submissionData.airTravelFreq === "frequently" || submissionData.airTravelFreq === "very-frequently") {
    tips.push({
  ...
  if (tips.length === 0) {
    tips.push(
      ...
      },
      {
        ...
        description: "Walk, bike, or use public transportation for short trips instead of driving when possible.",
        category: "Transportation",
        impact: "Medium",
        reasoning:
