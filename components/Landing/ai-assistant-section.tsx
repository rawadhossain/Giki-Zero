    ...
    <section className="py-20 px-4 bg-gradient-to-b from-gray-900 via-black to-gray-900 relative overflow-hidden">
              ...
              <g key={i}>
                ...
                {i < 10 && (
                  <line
                    ...
                    x2={x + 20 + Math.sin((mousePosition.x + (i + 5) * 50) * 0.01) * 3}
                    y2={y + Math.cos((mousePosition.y + (i + 5) * 50) * 0.01) * 3}
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {sampleQuestions.map((question, index) => (
                <div
                  key={index}
                  className={`group cursor-pointer px-6 py-3 rounded-full border-2 transition-all duration-500 transform hover:scale-105 ${
          ...
          <Button
            size="lg"
            className="group relative overflow-hidden bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 hover:from-green-600 hover:via-blue-600 hover:to-purple-600 text-white font-semibold px-12 py-6 rounded-full transition-all duration-300 transform hover:scale-110 shadow-2xl hover:shadow-green-500/25"
          >
            <MessageCircle className="w-6 h-6 mr-3 group-hover:animate-bounce" />
            <span className="relative z-10 text-lg">Chat with EcoBot Now</span>
