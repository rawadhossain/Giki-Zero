      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <div className="mb-16">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-4">
            Our Footprint{" "}
            <span className="bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">So Far</span>
          </h2>
            ...
            >
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <div className="mb-4">
                  ...
                  >
                    {achievement.count >= 1000 ? `${(achievement.count / 1000).toFixed(1)}K+` : `${achievement.count}+`}
                  </div>
                  ...
                  <div className="relative w-24 h-24 mx-auto mb-4">
                    <svg className="w-24 h-24 transform -rotate-90" viewBox="0 0 100 100">
                      ...
                      <circle
                        ...
                        strokeDashoffset={`${2 * Math.PI * 40 * (1 - (isVisible ? 0.75 : 0))}`}
                        className={`${
                          achievement.color === "green"
                            ? "text-green-400"
                            : achievement.color === "blue"
                ...
                <p className="text-gray-400 text-sm">{achievement.sublabel}</p>
              </CardContent>
            </Card>
          ))}
        </div>
