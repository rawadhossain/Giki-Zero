    ...
    <section className="py-20 px-4 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-15">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          <path
            d={`M0,20 Q${25 + Math.sin(mousePosition.x * 0.01) * 10},${10 + Math.cos(mousePosition.y * 0.01) * 5} 50,30 T100,25`}
          ...
          />
          <path
            d={`M0,50 Q${25 + Math.cos(mousePosition.x * 0.008) * 8},${40 + Math.sin(mousePosition.y * 0.008) * 6} 50,60 T100,55`}
            stroke="url(#flowGradient)"
            strokeWidth="0.3"
            fill="none"
            opacity="0.7"
          ...
          />
          <path
            d={`M0,80 Q${25 + Math.sin(mousePosition.x * 0.006) * 6},${70 + Math.cos(mousePosition.y * 0.006) * 4} 50,85 T100,82`}
            stroke="url(#flowGradient)"
            strokeWidth="0.4"
            fill="none"
            opacity="0.5"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-4">
            Your Sustainability{" "}
            <span className="bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">Companion</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-white/10 rounded-2xl p-6 mb-4 backdrop-blur-sm border border-gray-600">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-green-400 mb-2">2.4 tons</div>
                    <div className="text-white/80 text-sm">Monthly CO₂ Footprint</div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-gray-600">
                    <div className="text-green-400 text-2xl font-bold">🏆 7</div>
          ...
          <div className="order-1 md:order-2">
                  ...
                  <div className="flex items-start space-x-4 p-6 rounded-2xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 hover:border-green-400/50 hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        {activeStep >= index && <CheckCircle className="w-5 h-5 text-green-400 animate-scale-in" />}
                      </div>
            ...
            <div className="mt-8">
              <Button
                size="lg"
                className="group relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
